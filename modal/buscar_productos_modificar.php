<?php
	...
	?>	
			<!-- Modal -->
			<div class="modal fade bs-example-modal-lg" id="myModalagregar" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" onload="loadmodificar(1)" style="padding:50px;">
				...
				<div class="modal-content">
				  ...
				  <div class="modal-body" style="padding:10px; display:flex;">
					<div class="seccion1" style="flex:0 1 20%;width:100%">
						...
						<a href="#" class="limpiar btn btn-dark" title="Refrescar filtro" onclick="cargarfiltro_3()"><h2 class="titulo">Refrescar</h2></a>
					</div>
					<div class="seccion2" style="flex:0 1 80%;width:100%">
					  	<div class="form-group row busqueda"  style="display:flex;padding-top:5px;justify-content:center;margin:auto;5px;padding-bottom:20px;width:100%">
							...
							<div class="col-md-10" style="padding:0; padding-right:10px;">
								<input type="text" class="form-control" style="" id="q1" placeholder="Buscar productos" onkeyup="loadmodificar(1)" onkeydown="loadmodificar(1)" >
							</div>
							<button type="button" class="col-md-2 btn btn-dark" onclick="loadmodificar(1)"><span class='glyphicon glyphicon-search'></span> Buscar</button>
					  	</div>
					
						<div id="loader1" style="position: absolute;	text-align: center;	top: 55px;	width: 100%;display:none;"><div class="preloader"></div></div><!-- Carga gif animado -->
						<div class="outer_div1" id="outer_div1" ></div><!-- Datos ajax Final -->
					</div>
				  </div>
				  <div class="modal-footer">
					<button type="button" class="btn btn-dark" style="padding:10px 20px; border:1px solid #232323;" data-dismiss="modal">Cerrar</button>
