<?php
	...
	if (empty($_POST['mod_id'])) {
		...
		$sql="UPDATE clientes SET nombreCliente='".$nombre."', telefono='".$telefono."', mailCliente='".$email."', direccion='".$direccion."', estadoCliente='".$estado."' WHERE codigoCliente='".$id_cliente."'";
