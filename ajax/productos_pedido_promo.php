<?php
	...
	//verificar si existe variable de sesion promocion
						...
						while ($row=mysqli_fetch_array($query)){
								...
								<tr >
									...
									<td  style="text-align:center;"><div class="pull-right">
										<input type="number"  class="form-control" min="1" onkeyup="el2('<?php echo $id_producto; ?>')"  style="text-align:center" id="cantidad_<?php echo $id_producto; ?>"  value="1" >
									</div></td>
									<td  style="text-align:center;" ><div class="pull-right">
									...
									<td style="" class='text-center'><a   class='agregar'href="#" onclick="agregarpromo('<?php echo $id_producto ?>')"><i  class="glyphicon glyphicon-plus"></i></a></td>
								</tr>
